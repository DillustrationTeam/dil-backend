...
public interface ICommissionService
{
    ...
    Task<CommissionDetailDto?> GetCommissionByIdAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    Task<DisputeDto?> GetDisputeByCommissionIdAsync(Guid id, CancellationToken cancellationToken = default);
