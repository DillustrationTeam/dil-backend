...
namespace ArtCommission.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921175834_AddMarketplaceDiscoveryInteractions")]
    partial class AddMarketplaceDiscoveryInteractions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtCommission.Domain.Entities.ArtistStudio.ArtworkComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ArtworkId", "CreatedAt");

                    b.ToTable("ArtworkComments", (string)null);
                });

            modelBuilder.Entity("ArtCommission.Domain.Entities.ArtistStudio.ArtworkFavorite", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ArtworkFavorites", (string)null);
                });
            ...
            modelBuilder.Entity("ArtCommission.Domain.Entities.ArtistStudio.CollectionArtwork", b =>
                {
                    ...
                    b.ToTable("CollectionArtworks", (string)null);
                });

            modelBuilder.Entity("ArtCommission.Domain.Entities.ArtistStudio.CommissionService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CreatorProfileId", "IsActive");

                    b.ToTable("CommissionServices", (string)null);
                });
            ...
            modelBuilder.Entity("ArtCommission.Domain.Entities.ArtistStudio.CreatorReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CreatorProfileId", "CreatedAt");
            ...
            modelBuilder.Entity("ArtCommission.Domain.Entities.ArtistStudio.CollectionArtwork", b =>
                {
                    ...
                    b.HasOne("ArtCommission.Domain.Entities.ArtistStudio.PersonalCollection", "Collection")
